...
@section('page-title', 'Komponen Penilaian')
@section('page-description', 'Kelola bobot penilaian untuk setiap mata kuliah')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <form method="GET" action="{{ route('komponen.index') }}" class="flex flex-col md:flex-row gap-3">
            ...
            <select name="status" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                ...
                <option value="sudah" {{ request('status') == 'sudah' ? 'selected' : '' }}>Sudah Ada Komponen</option>
            ...
            @if(request('search') || request('status'))
                <a href="{{ route('komponen.index') }}" class="bg-gray-500 text-white px-6 py-2 rounded-lg hover:bg-gray-600 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            <a href="{{ route('komponen.create', $matakuliah) }}" 
                               class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all shadow hover:shadow-lg text-sm">
                                ...
                                {{ $matakuliah->komponenPenilaian ? 'Edit' : 'Atur' }}
                            </a>
                        </td>
                    </tr>
                    @empty
